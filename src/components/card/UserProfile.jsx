...
const UserProfile = (props) => {
  ...
  const { avatar, dateOfBirth, fullName, gender, username } =
    profileDetails
    ...
    <div className="flex flex-col w-full items-center justify-center font-ubuntu py-5 px-5 text-main dark:text-snow duration-300 ease-in-out">
      <div className="flex flex-col w-full items-center justify-center space-y-4">
        ...
        <div className="flex w-40 h-40">
          <img
            src={avatar}
            className="w-full object-cover object-center rounded-full p-2 outline outline-offset-1 outline-main dark:outline-white duration-300 ease-in-out"
          />
        </div>
        ...
        <div className="flex flex-col w-full rounded-md bg-milk dark:bg-alternate items-start justify-start space-y-2 px-5 py-5 duration-300 ease-in-out">
          {/* Header About */}
          <div className="flex flex-row w-full items-center justify-center lg:items-start lg:justify-start">
            <div className="flex items-center space-x-2">
                <RiProfileLine className="h-8 w-8 fill-main dark:fill-snow duration-300 ease-in-out" />
            ...
            <div className="">
              <div className="grid md:grid-cols-2 text-sm">
                ...
                <div className="grid grid-cols-2">
                  ...
                  <div className="px-4 py-2">{moment(dateOfBirth).format('LL')}</div>
                </div>
