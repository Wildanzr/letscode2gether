const SampleCase = (props) => {
  ...
  return (
    <div className="flex flex-col py-2 w-full text-base text-white">
      ...
      <p className="my-1 px-2 py-2 font-mono bg-white w-full font-mono text-sm text-black">
        {input}
      </p>
      <p className="mb-0 text-sm">Output (stdout)</p>
      <p className="my-1 px-2 py-2 bg-white w-full font-mono text-sm text-black">
        {output}
      </p>
    </div>
  )
